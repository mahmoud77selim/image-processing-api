...
import { imagesPath, createThumbnailName, imageDirsTypes } from '../utils';
...
export const ResizerKit: Router = Router();

ResizerKit.get('/resize', async (req: Request, res: Response) => {
  const { h, w } = req.query;
